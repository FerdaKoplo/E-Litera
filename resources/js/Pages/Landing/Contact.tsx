...
const Contact = () => {
    return (
        <div className='flex flex-col justify-center items-center min-h-screen gap-20'>
            <div className='text-4xl items-center gap-5 font-semibold flex flex-col '>
                <h1>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 max-w-6xl mx-auto">
                {ContactConstant.map((item, index) => (
                    <Card
                        key={item.id}
                        className="flex flex-col items-center justify-center p-6 text-center hover:shadow-lg transition-shadow duration-300 space-y-4"
                    >
